...
project_root = '/mnt/qb/work/baumgartner/cbaumgartner/libauc-chexpert/'

# Index: -1 denotes multi-label mode including 5 diseases
traindSet = CheXpert(csv_path=data_root+'train.csv', image_root_path=data_root, use_upsampling=False, use_frontal=True, image_size=224, mode='train', class_index=-1, verbose=False)
testSet =  CheXpert(csv_path=data_root+'valid.csv',  image_root_path=data_root, use_upsampling=False, use_frontal=True, image_size=224, mode='valid', class_index=-1, verbose=False)
      ...
      if idx % 400 == 0:
         ...
         with torch.no_grad():    
              ...
              if best_val_auc < val_auc_mean:
                 ...
                 torch.save(model.state_dict(), project_root + 'aucm_multi_label_pretrained_model.pth')
